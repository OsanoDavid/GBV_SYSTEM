...
if not DEBUG:
    ...
    # Render proxies HTTPS but passes HTTP internally, so trust the proxy headers
    SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')
    # Only redirect if NOT behind a proxy (i.e., not on Render)
...
# Ensure a logs directory exists and configure basic logging to file and console
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(LOG_DIR, 'gv_system.log'),
            'formatter': 'standard',
        },
    },
    'root': {
