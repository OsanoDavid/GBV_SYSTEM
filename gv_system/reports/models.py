...
class IncidentReport(models.Model):
    ...
    id_type = models.CharField(max_length=50, default='National ID')
    national_id_number = models.CharField(max_length=50, blank=True, null=True)
    contact_mode = models.CharField(max_length=50, default='Phone Number')
    ...
    gender = models.CharField(max_length=20, default='P')
